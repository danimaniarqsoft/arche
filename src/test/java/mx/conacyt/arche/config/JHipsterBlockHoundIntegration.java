package mx.conacyt.arche.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("mx.conacyt.arche.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("mx.conacyt.arche.security.DomainUserDetailsService", "createSpringSecurityUser");
    }
}
