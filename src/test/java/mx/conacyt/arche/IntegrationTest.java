...
import mx.conacyt.arche.ArcheApp;
import mx.conacyt.arche.config.AsyncSyncConfiguration;
import mx.conacyt.arche.config.EmbeddedMongo;
...
@SpringBootTest(classes = { ArcheApp.class, AsyncSyncConfiguration.class })
@EmbeddedMongo
